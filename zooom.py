...
reciver = AudioReceiver(local_ip_address,4444)
...
def start_screen_sharing():
    screen_client=ScreenShareClient(text_target_ip.get(1.0,'end-1c'),8888)
...
btn_screen=tk.Button(window, text="Start Screen",width=50,command=start_screen_sharing)
